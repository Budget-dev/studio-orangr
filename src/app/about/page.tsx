        ...
        <section className="py-24">
          <div className="max-w-[1080px] mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-normal text-black leading-tight mb-8">Rooted in Strategy, <span className="text-primary italic font-bold">Reaching the World</span></h2>
              <div className="space-y-6 text-[#6b5247] leading-relaxed text-[17px]">
                <p>Founded in 2005, Shyama Overseas started with a vision to revolutionize the way brands connect with global audiences. From our beginnings in Mumbai, we've grown into a powerhouse of digital strategy, performance marketing, and creative technology.</p>
            ...
            <div className="bg-[#fdf6f2] p-12 rounded-2xl border-2 border-primary/5 relative">
              ...
              <div className="grid grid-cols-2 gap-6 relative z-10">
                {[["150+", "Clients"], ["40+", "Markets"], ["19+", "Years"], ["10M+", "Impressions"]].map(([n, l]) => (
        ...
        <section className="py-24 bg-[#f5f5f5]">
          <div className="max-w-[1080px] mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { icon: Shield, t: "Trust & Transparency", d: "Clear data, honest reporting, and ethical strategy are our non-negotiable standards." },
                { icon: Zap, t: "Speed & Scale", d: "Leveraging technology for the fastest growth and sustainable scaling in the industry." },
                { icon: Users, t: "Client-Centric", d: "Every strategic decision is filtered through the lens of client growth and long-term benefit." }
              ].map((v, i) => (
